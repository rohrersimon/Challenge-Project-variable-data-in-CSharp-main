    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (validInput == "")
            {
                ...
                {
                    validInput = readResult.ToLower().Trim();
                    Console.WriteLine();
                }
            }

            string[] dogCharacteristics = validInput.Split(',');
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string dogCharacteristic in dogCharacteristics)
                    {
                        ...
                        for (int j = 2; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]}...{dogCharacteristic} {icon} {j}");
                                Thread.Sleep(500);
                            }
                        ...
                        if (dogDescription.Contains(dogCharacteristic))
                        {
                            ...
                            Console.WriteLine($"Our dog {ourAnimals[i, 3]} is a match for {dogCharacteristic}!");
                            thisDogMatches = true;
                            noMatchesDog = false;
                        }
                    }
            ...
            if (noMatchesDog)
            {
                Console.WriteLine("None of our dogs are a match found for: " + validInput);
            }
